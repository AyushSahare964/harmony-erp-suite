...
export function VisitWorkspaceModal({ open, onClose, visit, onVisitFinalized }: VisitWorkspaceProps) {
  ...
  // Live Inventory Linked: Animal Food State
  const [foodItems, setFoodItems] = useState<{ id: string; name: string; packSize: string; quantity: number; price: number; itemCode?: string | undefined }[]>([]);
  ...
  // Live Inventory Linked: Animal Accessories State
  const [accessoryItems, setAccessoryItems] = useState<{ id: string; name: string; category: string; quantity: number; price: number; itemCode?: string | undefined }[]>([]);
  ...
  const handleAddFoodItem = () => {
    ...
    setFoodItems((prev) => [
      ...prev,
      { id, name, packSize: pack, quantity: qty, price, itemCode },
    ]);
  ...
  const handleAddAccessoryItem = () => {
    ...
    setAccessoryItems((prev) => [
      ...prev,
      { id, name, category, quantity: qty, price, itemCode },
    ]);
                ...
                <div className="erp-card p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="rounded-xl border border-border/80 bg-muted/20 p-3 space-y-3">
                      ...
                      {/* Controls Row: Qty, Price and Add Button */}
