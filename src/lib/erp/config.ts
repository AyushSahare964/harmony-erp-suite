...
export const ROLES: Record<RoleId, RoleConfig> = {
  doctor: {
    ...
    person: "Dr. Makarand M. Dixit",
    initials: "MD",
    scope: "Real Care Small Animal Clinic — Nagpur",
    ...
    kpis: [
      { label: "Patients Waiting", value: "0", trend: "OPD queue clear", trendTone: "flat" },
  ...
  admin: {
    ...
    kpis: [
      { label: "Today's appointments", value: "0", trend: "0 scheduled", trendTone: "flat" },
      { label: "Revenue today", value: "₹0", trend: "₹0 collected today", trendTone: "flat" },
      { label: "Boarding occupancy", value: "0%", trend: "0 active stays", trendTone: "flat" },
      { label: "Low-stock items", value: "0", trend: "Stock healthy", trendTone: "flat" },
      { label: "Staff on shift", value: "0", trend: "0 on shift", trendTone: "flat" },
    ],
    blocks: [
      {
  ...
  reception: {
    ...
    kpis: [
      ...
      { label: "Today's Appointments", value: "0", trend: "0 scheduled", trendTone: "flat" },
      { label: "New Client Intakes", value: "0", trend: "0 today", trendTone: "flat" },
      { label: "Boarding & Pool Check-ins", value: "0", trend: "0 today", trendTone: "flat" },
    ],
    blocks: [
      {
