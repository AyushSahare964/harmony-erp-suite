...
import { calculateQuickDate, formatDisplayDate } from "../src/lib/utils/dateUtils.js";
...
import { calcBillSummary, calcLineItem, roundMoney } from "../src/lib/utils/moneyUtils.js";
...
const candyItems = [
  { name: "Consultation Fee", quantity: 1, unitPrice: 500, discountType: "percentage", discountValue: 0 },
  { name: "Medicine A (Amoxicillin)", quantity: 1, unitPrice: 120, discountType: "percentage", discountValue: 0 },
  { name: "Medicine B (Cefpet)", quantity: 1, unitPrice: 150, discountType: "percentage", discountValue: 0 },
  { name: "Rabies Vaccine", quantity: 1, unitPrice: 480, discountType: "percentage", discountValue: 0 },
  { name: "Royal Canin Maxi", quantity: 1, unitPrice: 1850, discountType: "percentage", discountValue: 0 },
  { name: "PawShield Collar", quantity: 1, unitPrice: 300, discountType: "percentage", discountValue: 0 },
];
